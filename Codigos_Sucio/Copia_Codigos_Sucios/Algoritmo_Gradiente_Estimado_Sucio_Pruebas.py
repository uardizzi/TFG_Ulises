...
#Antes de meterlo dentro de su algoritmo probare el avance dentro de esta pestaña
# Recordar que el avance se hace en funcion del descenso del gradiente.
ck = xo
for k in range(100):
    epsilon = 1
...
# A partir de aca me di cuenta la necesidad de hacer una funcion para poder llamarla.
#  Y que me calcule el gradiente cada vez que le pase dos puntos sobre el grafico
